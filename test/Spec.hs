...
-- TODO:  Utiliser suchThat pour faire de la génération avec rejet ?

-- TODO : Générateur récursif ?

-- TODO : Générateur sur structures avec invariants pour les types complexes ? (genBridgeLim ?)
